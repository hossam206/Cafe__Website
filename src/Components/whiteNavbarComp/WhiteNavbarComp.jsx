...
export default function WhiteNavbarComp() {
  ...
  // function go to top
  document
    .querySelectorAll(".whiteNavbar .Navbar-content li a")
    .forEach((footerLink) => {
  ...
  return (
    <>
      {/* {loader && <Loaderr />} */}
      <NavbarMobile />
      <div className={`whiteNavbar ${TransitionNavbar} `}>
        <Container fluid>
          <div className="Navbar-content">
            ...
            <div className="NavbarLogo">
              <img src={DarkLogo} alt="DarkLogo" loading="lazy"></img>
            </div>
        ...
        <div className={`NavbarCart ${NavbarCart}`}>
          ...
          <div className="NavbarCartContent">
            {CartProducts.map((product) => {
              return (
                <div className="NavbarCartProduct">
